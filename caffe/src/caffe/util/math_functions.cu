...
template<>
void caffe_gpu_max(int n, const float* x, int* result)
{
  cublasIsamax(Caffe::cublas_handle(), n, x, 1, result);
}

template<>
void caffe_gpu_max(int n, const double* x, int* result)
{
  cublasIdamax(Caffe::cublas_handle(), n, x, 1, result);
}

template<>
void caffe_gpu_min(int n, const float* x, int* result)
{
  cublasIsamin(Caffe::cublas_handle(), n, x, 1, result);
}

template<>
void caffe_gpu_min(int n, const double* x, int* result)
{
  cublasIdamin(Caffe::cublas_handle(), n, x, 1, result);
}
