...
void NormalizationL2Layer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
//  LOG(INFO) << "l2_normalization start";
...
template <typename Dtype>
void NormalizationL2Layer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(NormalizationL2Layer);
}  // namespace caffe