...
namespace caffe 
{
	...
	class SetLossLayerTest : public MultiDeviceTest<TypeParam>
	{
...
TYPED_TEST_CASE(SetLossLayerTest, TestDtypesAndDevices);


TYPED_TEST(SetLossLayerTest, TestGradient)
{
	typedef typename TypeParam::Dtype Dtype;
	LayerParameter layer_param;
	SetLossLayer<Dtype> layer(layer_param);
